...
;;	David S. Rosinger <dsrosing@ingr.com> (minor Win32 patches only)
;; Maintainer: Lawrence R. Dodd <dodd@roebling.poly.edu>
;; Created: crypt.el in 1988, crypt++.el on 18 Jan 1993
;; Version: 2.82 (with Win32 patch)
;; Date: 1994/03/31 12:30:17 (Win32: 1997/05/23 10:26:00)
;; Keywords: extensions
...
;;;   Use them.
;;; 2.82 (Win32) -
;;;   dsr: Make package operational under Win32 by making calls to
;;;   `binary-process-input' and `binary-process-output'.  This package will
;;;   not work with COMMAND.COM on Windows 95; you must use a 32-bit shell.
   ...
   (let (prog args)
     ...
     (cond
      ...
      ((stringp prog)
       ...
       (call-process-region start end shell-file-name t t nil shell-command-switch prog)) ; Win32
