;; dir-project.el --- utilities for finding DIRPROJECT in emacs

;; Author          : Wilson Snyder <wsnyder@wsnyder.org>

;; INSTALLATION:
;;
;; Add dir-project.el in a directory under your M-x describe-variable load-path
;;
;; If using verilog-mode.el add to your .emacs (or site-start) file:
;;   (require 'dir-project)
